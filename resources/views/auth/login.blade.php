        ...
        <div class="premium-panel rounded-2xl p-7 sm:p-8">
            <div class="mb-8 text-center">
                ...
                <h2 class="text-3xl font-black tracking-tight text-white">
                    Gimnasio <span class="text-premium-gold">Pretorianos</span>
                </h2>
            </div>
            ...
            <div class="mt-6 flex items-center justify-center gap-2 text-sm text-slate-300">
                <span>¿No tienes cuenta?</span>
                <a href="{{ route('register') }}" class="font-semibold text-premium-gold transition hover:text-yellow-300">
                    Regístrate aquí
                </a>
            </div>
        </div>
